...
import { 
    GraduationCap, LogOut, Briefcase, Calendar, FileText, ChevronRight, Loader, 
    List, Grid, Zap // Added List and Grid icons
} from 'lucide-react';
            ...
            <div>
                ...
                <div className="flex items-center text-sm text-gray-500 mt-0.5 space-x-4">
                    ...
                    <span className="flex items-center gap-1">
                        ...
                        <span className="font-medium text-gray-700">{cert.institutionName}</span>
                    </span>
                </div>
            </div>
        </div>
...
const CertificateGridItem = ({ cert, onClick }) => (
    ...
    >
        ...
        <div className="flex justify-between items-start mb-4 relative z-10">
            ...
            {/* Institution Name */}
            <p className="text-sm font-medium text-indigo-800 mt-1">{cert.institutionName}</p>
        </div>
        ...
        <div className="flex-1 relative z-10">
            ...
            {cert.recipientName && (
                <p className="text-sm text-gray-500 italic mb-2">
                    Awarded to: <span className="font-semibold text-gray-700">{cert.recipientName}</span>
                </p>
            )}
            {/* Description */}
        ...
        <div className="mt-4 pt-4 border-t border-indigo-100 flex justify-between items-center relative z-10">
            <span className="text-xs text-gray-500 flex items-center gap-1 font-medium">
                <Calendar className="w-3 h-3 text-indigo-400" />
                Completed: <span className="text-gray-700 font-semibold">{formatDate(cert.issuedAt)}</span>
            </span>
...
const StudentPage = () => {
    ...
    const [student] = useState(
        studentInfo || { name: "User", email: "loading...", id: "...", role: "Student" }
    );
                ...
                <header className="bg-white/90 backdrop-blur-md border-b border-gray-200 sticky top-0 z-20 shadow-sm">
                    <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl font-semibold tracking-tight text-gray-900">{student.name}</h1>
                ...
                <main className="max-w-6xl mx-auto px-6 py-12">
                    ...
                    {certificates.length === 0 ? (
                        <div className="bg-white p-10 rounded-xl border border-gray-200 shadow-md text-center">
                            <p className="text-gray-500 text-lg">No official credentials found in your account.</p>
                        </div>
                    ) : (
